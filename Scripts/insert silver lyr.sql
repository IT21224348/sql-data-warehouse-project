...
BEGIN
    DECLARE @Start_time DATETIME, @End_time DATETIME, @Batch_endtime DATETIME, @Batch_starttime DATETIME 
    BEGIN TRY
		...
		PRINT '>>Inserting Data Into:silver.erp_cust_az_12'
		...
		PRINT ' - Total Load Duration: '+ CAST(DATEDIFF(SECOND,@Batch_starttime, @Batch_endtime) AS NVARCHAR)
